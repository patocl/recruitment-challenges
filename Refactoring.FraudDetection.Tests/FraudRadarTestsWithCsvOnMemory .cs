...
namespace Refactoring.FraudDetection.Tests
{
    ...
    [TestClass]
    public class FraudRadarTestsWithCsvOnMemory
    {
        [TestMethod]
        ...
        /// <summary>
        /// Fake Reader, to read from Memory instead from Disk
        /// </summary>
        private static IList<IFraudResult> ExecuteTest(string filePath)
        {
            var fraudRadar = new FraudRadar();
            var fileReader = FakeHelper.CreateFakeFileMemoryReader(filePath);
